            ...
            <div class="flex max-width-pannel">
                <div class="pannel">
                    ...
                    <div class="w20 ptb20 text-end">
                        <a class="btnS not" href="#" @click.prevent="parent.formData=user;$refs.new.active=1"><i class="fas fa-edit"></i> Edit user</a>
                    </div>
                </div>
            </div>
